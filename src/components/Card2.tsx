...
const Card2: React.FC<Card2Props> = ({ title, description1, description2, list, image }) => {
    return (
        <div className="flex max-w-[644px] px-[24px] h-auto md:h-[932px] items-center flex-col border-[2px] border-[#E1E3E6] bg-[#F6F8FA] rounded-[6px]  justify-between gap-[12px] md:gap-[110px] py-[64px]">
