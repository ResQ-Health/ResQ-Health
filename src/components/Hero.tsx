        ...
        <div className='w-full relative flex justify-center'>
            <div className="relative w-full h-[514px] flex-col justify-center py-[71px]">
                ...
                <div className="max-w-full px-4">
                    <h1 className='font-plus-jakarta font-semibold text-[24px] md:text-[40px] leading-[36px] md:leading-[64px] text-center text-[#FFFFFF]'>
                ...
                <div className='flex justify-center mt-[16px] mb-[26px]'>
                    <button
                        ...
                        className='bg-[#06202E] text-[#FFFFFF] px-[16px] py-[8px] rounded-[8px] hover:bg-[#1a3a4e] transition-colors flex items-center gap-2 text-[14px] md:text-[16px]'
                    >
