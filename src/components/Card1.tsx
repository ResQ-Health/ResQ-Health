            ...
            <div className="flex-1 max-w-[552px]">
                ...
                {items.length > 0 && <ul className="list-disc pl-5 space-y-3 flex flex-col gap-[16px]">
                    {items.map((item, index) => (
                        <li key={index} className="text-[20px] leading-[32px] text-[#4B5563]">
                            {item}
                        </li>
                    ))}
                </ul>}
                {description2 && (
                    <a
                        ...
                        className="text-[20px] mt-[24px] underline underline-offset-4 leading-[24px] text-[#4B5563] flex items-center gap-2 hover:text-[#06202E] transition-colors cursor-pointer"
                    >
